...
def print_preamble(path):
	...
	for line in preamble:
		...
		if line.find("\\IfFileExists{") == 0:
			line = line.replace("latex-project", "latex-project-book")
...
print "\\centerline{\\LARGE\\bfseries Manifolds Project}"
print "\\vskip1in"
print "\\noindent"
print "\\centerline{"
print_version(path)
...
print "\\end{titlepage}"
# print_license_blurp(path) # TODO: Add this back; add an actual introduction.
print "\\tableofcontents"

list_stems = list_text_files(path)
list_stems.append("index")
